          ...
          <Col lg={24} xs={24}>
            <div style={{ marginTop: 10 }}>
              <h2 style={{ marginBottom: 0 }}>
                {getGreetings(new Date())}, {user?.first_name} {user?.last_name}
              </h2>
          ...
          <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }} style={{ marginBottom: 30, marginTop: 20 }}>
            <Col className="gutter-row" xs={24} sm={12} md={12} lg={6} style={{ marginBottom: 20 }}>
              {isLoading ? (
                ...
                <Card style={styles.countingCardStyles1} bordered={false} hoverable={true}>
                  <Row gutter={25}>
                    <Col span={18}>
                      <h3 style={styles.cardHeadTextStyles}>Shipped Orders</h3>
                      <p style={styles.cardMainNumberTextStyles}>
                        <CountUp duration={2} end={analytics?.data?.totalShippedOrder} />
                      </p>
                    </Col>
                    <Col span={6}>
                  ...
                  <Row gutter={25} style={{ marginTop: 10 }}>
                    <Col xs={12} sm={12} md={12} lg={12}>
                      <p style={styles.cardNumberTextStyles}>
                        Today Shipped:
                        <br />
                        <CountUp style={{ fontSize: 15 }} duration={2} end={analytics?.data?.todayShippedOrder} />
                      </p>
                    </Col>
                    <Col xs={12} sm={12} md={12} lg={12}>
                      <p style={styles.cardNumberTextStyles}>
                        In-Progress:
                        <br />
                        <CountUp style={{ fontSize: 15 }} duration={2} end={analytics?.data?.shippingInProgress} />
                      </p>
                    </Col>
                  </Row>
                </Card>
            ...
            <Col className="gutter-row" xs={24} sm={12} md={12} lg={6} style={{ marginBottom: 20 }}>
              {isLoading ? (
                ...
                <Card style={styles.countingCardStyles2} bordered={false} hoverable={true}>
                  <Row gutter={25}>
                    <Col span={18}>
                      <h3 style={styles.cardHeadTextStyles}>Orders</h3>
                      <p style={styles.cardMainNumberTextStyles}>
                        <CountUp duration={2} end={analytics?.data?.orderCount} />
                      </p>
                    </Col>
                    <Col span={6}>
                  ...
                  <Row gutter={25} style={{ marginTop: 10 }}>
                    <Col span={10}>
                      <p style={styles.cardNumberTextStyles}>
                        New Order
                        <br />
                        <CountUp duration={2} style={{ fontSize: 15 }} end={analytics?.data?.newOrderCount} />
                      </p>
                    </Col>
                    <Col span={14}>
                      <Button style={styles.styledButton1} type="primary">
                        Manage <br /> Today Orders
                      </Button>
                    </Col>
                  </Row>
                </Card>
            ...
            <Col className="gutter-row" xs={24} sm={12} md={12} lg={6} style={{ marginBottom: 20 }}>
              {isLoading ? (
                ...
                <Card style={styles.countingCardStyles3} bordered={false} hoverable={true}>
                  <Row gutter={25}>
                    <Col span={18}>
                      <h3 style={styles.cardHeadTextStyles}>Quotes</h3>
                      <p style={styles.cardMainNumberTextStyles}>
                        <CountUp duration={2} end={analytics?.data?.totalQuotes} />
                      </p>
                    </Col>
                    <Col span={6}>
                  ...
                  <Row gutter={25} style={{ marginTop: 10 }}>
                    <Col span={10}>
                      <p style={styles.cardNumberTextStyles}>
                        New Quotes
                        <br />
                        <CountUp style={{ fontSize: 15 }} duration={2} end={analytics?.data?.todayQuotes} />
                      </p>
                    </Col>
                    <Col span={14}>
                      <Button style={styles.styledButton1} type="primary">
                        Manage <br /> New Quotes
                      </Button>
                    </Col>
                  </Row>
                </Card>
            ...
            <Col className="gutter-row" xs={24} sm={12} md={12} lg={6} style={{ marginBottom: 20 }}>
              {isLoading ? (
                ...
                <Card style={styles.countingCardStyles4} bordered={false} hoverable={true}>
                  <Row gutter={25}>
                    <Col span={18}>
                      <h3 style={styles.cardHeadTextStyles}>New Customers</h3>
                      <p style={styles.cardMainNumberTextStyles}>
                        <CountUp duration={2} end={analytics?.data?.newCustomer} />
                      </p>
                    </Col>
                    <Col span={6}>
                  ...
                  <Row gutter={25} style={{ marginTop: 10 }}>
                    <Col span={12}>
                      <p style={styles.cardNumberTextStyles}>
                        Total
                        <br /> <CountUp style={{ fontSize: 15 }} duration={2} end={analytics?.data?.totalCustomer} />
                      </p>
                    </Col>
                    <Col span={12}>
                      <p style={styles.cardNumberTextStyles}>
                        Verified
                        <br /> <CountUp style={{ fontSize: 15 }} duration={2} end={analytics?.data?.verifiedCustomer} />
                      </p>
                    </Col>
                  </Row>
                </Card>
