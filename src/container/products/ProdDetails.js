...
const prodDeatails = () => {
    ...
    useEffect(() => {
        ...
        apolloClient.query({
            ...
            variables: { query: { prod_uuid: productId } },
            context: {
                headers: {
                                    ...
                                    <Col xs={24} lg={10}>
                                        <div className="product-details-box__left pdbl">
                                            <figure>
                                                ...
                                                {/* <img style={{ width: '100%' }} src={"https://d2wd2j5j7vio4j.cloudfront.net/data/carpets/Mobile/40-999621-306x212-07.jpg"} alt="" /> */}
                                                <img style={{ width: '100%' }} src={`https://api.primeserverparts.com/images/product/image/thumbnail/${product.data.prod_uuid}/400x400_${product.data.prod_thumbnail}`} alt="" />
                                            </figure>
                                        </div>
                                    </Col>
                                    <Col xs={24} lg={14}>
                                        ...
                                        <span className="pdbr__review-count"> 778 Reviews</span> */}
                                            <p>
                                                ...
                                                <span className="pdbr__brand-name">
                                            ...
                                            {product?.data?.part_of_products?.length ? <>
                                                ...
                                                <ol>
                                                    {product?.data?.part_of_products.map(prod => (
                                                        <li key={prod.prod_uuid}
                                                            onClick={() => setProductId(prod?.part_product?.prod_uuid)}
                                                        >
                                                            <a>
                                                                {prod?.part_product?.prod_name}
                                                            </a>
                                                        </li>
                                                    ))}
                                                </ol>
