...
export default function AddAddress({ type, addressModalOpen, setAddressModalOpen, handleSubmit }) {
  ...
  return (
    <Modal
      title={`Add ${strCamelCase(type)} Address`}
      style={{ top: 20 }}
      width={600}
      ...
      >
        <Row gutter={25}>
          <Col md={24}>
            <Row gutter={25}>
              <Col xs={24} md={12}>
                <Form.Item name="country" initialValue="US" label="Country" style={{ marginBottom: 5 }}>
                  <Select
            ...
            <Form.Item name="address2" label="Address 2" style={{ marginBottom: 5 }}>
            ...
            <Row gutter={{}}>
              ...
              <Col xs={24} md={12} style={{ paddingLeft: 15 }}>
                <Form.Item name="isDefault" label="Default" style={{ marginBottom: 0 }}>
